...
const mark = `data:image/svg+xml;base64,${btoa(
  '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 100">' +
    '<path fill="#155962" d="M0 0h13.2v100H0z M39.4 19.9H64L40.2 43.7v-9.2L13.2 61.5V46.1z M18.6 100V65.1l13.3-13.3L64 83.9H46.1L31.5 69.3V100z"/>' +
  ...
  return new ImageResponse(
    ...
    >
      ...
      >
        ...
        <span style={{ marginLeft: 14, color: '#155962' }}>keel</span>
