...
import { classifyManipulation, type ManipulationOutcome } from '@/lib/format/cost';
    ...
    <div className={cn('relative overflow-x-auto rounded-lg border border-[var(--keel-border)]', className)}>
      <table className="w-full border-collapse text-sm">
        <caption className="sr-only">
          ...
          book alone, with whether the target is reachable at all.
        </caption>
        <thead>
        ...
        <tbody>
          {combined.map((rung) => {
            ...
            return (
              ...
              >
                <th scope="row" className="px-3 py-2 text-left font-medium tabular">
