import { CircleCheck, OctagonAlert, OctagonX, TriangleAlert } from 'lucide-react';
import type { LucideIcon } from 'lucide-react';

import { BAND_ORDER, BAND_TOKENS, CONFIDENCE_TOKENS } from '@/lib/design/tokens';
import type { Band, BandConfidence } from '@/lib/format/flags';
...
export function BandSegments({ band, confidence, className }: BandSegmentsProps) {
