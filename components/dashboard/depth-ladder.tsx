...
import { barRatios, stackRatio, toPercent } from '@/lib/keel/chart/geometry';
  ...
  return (
    <div className={cn('flex flex-col gap-4', className)}>
      ...
      <p className="text-xs text-[var(--keel-muted)]">
        Bars share one scale. The venue split decomposes the buy side; the sell
        side is drawn as an outline because its composition is not reported.
      </p>
    </div>
  );
}
        ...
        {ratio === null ? (
          ...
          <div
            className={cn(
              ...
              outlined &&
                'border border-[var(--keel-border-strong)] bg-[var(--keel-surface)]',
            )}
