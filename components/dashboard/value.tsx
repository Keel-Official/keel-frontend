...
import { formatDecimal, withUnit } from '@/lib/keel/format/decimal';
...
export function Value({
  ...
  const exactWithUnit = showUnit
    ? withUnit(value.exact, value.unit)
    : value.exact;
...
function Unmeasured({
  ...
  const words =
    state === 'absent' ? UNMEASURED_WORDS.absent : UNMEASURED_WORDS.unknown;
