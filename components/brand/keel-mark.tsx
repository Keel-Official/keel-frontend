 ...
 *
 * The navy strokes take `currentColor` rather than a brand token so the mark
 * survives an inverted surface — the footer and the dashboard's dark theme
 * both put it on ink. The counter keeps the literal brand amber, which holds
 * its contrast on light and dark alike, so it is the one fixed colour here.
 *
